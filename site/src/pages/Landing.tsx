...
export function Landing() {
  return (
    <main id="main">
      ...
      <section id="scorecard" className="sec" aria-labelledby="h-score"><div className="wrap grid grid-cols-[7fr_5fr] items-center gap-[clamp(40px,6vw,96px)] max-[900px]:grid-cols-1 max-[900px]:gap-10">
      ...
      <section id="record" className="sec" aria-labelledby="h-record"><div className="wrap grid grid-cols-[5fr_7fr] items-center gap-[clamp(40px,6vw,96px)] max-[900px]:grid-cols-1 max-[900px]:gap-10">
        <div className="max-[900px]:order-2"><h2 id="h-record" className="mb-5">It writes down what it said. Then it checks.</h2>
        ...
        <div className="overflow-x-auto rounded-[12px] border border-tline bg-tpanel text-text shadow-[0_24px_60px_-24px_rgba(0,0,0,.6)] max-[900px]:order-1" aria-label="The call log: ticker, call, held, versus index, result">
      ...
      <section id="sizing" className="sec" aria-labelledby="h-size"><div className="wrap max-w-[920px]">
        ...
        <div className="mt-10 grid grid-cols-5 gap-px overflow-hidden rounded-[12px] border border-line bg-line max-[900px]:grid-cols-2 max-[600px]:grid-cols-1" role="list" aria-label="The five sizing limits, illustrative">
      ...
      <section id="who" className="sec" aria-labelledby="h-who"><div className="wrap">
        ...
        <div className="grid grid-cols-2 items-start gap-[clamp(32px,5vw,80px)] max-[900px]:grid-cols-1 max-[900px]:gap-8">
          ...
          <div className="col-span-full mt-6 grid grid-cols-2 items-start gap-[clamp(32px,5vw,80px)] border-t border-line pt-8 max-[900px]:grid-cols-1 max-[900px]:gap-8"><h3 className="text-faint">Who it is not for.</h3><p className="text-[17px] text-dim">Anyone looking for a tip, a signal, or a number that says how often it wins. It does not place trades, does not connect to a broker, and is not investment advice. Judgement stays with the person at the keyboard.</p></div>
        </div>
      </div></section>
      ...
      <section id="request" className="sec" aria-labelledby="h-access"><div className="wrap">
        ...
        <div className="grid grid-cols-[minmax(0,560px)_1fr] items-start gap-[clamp(40px,6vw,96px)] max-[900px]:grid-cols-1 max-[900px]:gap-12">
          <RequestForm />
          <dl className="mt-[6px]">

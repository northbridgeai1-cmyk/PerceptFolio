...
export function Nav() {
  ...
  /* Someone who has entered before does not need to be sold to: the one primary action becomes
     "Resume session" and opens the terminal. "Entered before" is a terminal profile in this browser
     or the door's pf_seen cookie, which /api/enter sets for a year. */
